...
Rozděleno na úseky (zhruba po týdnech), ale **bez pevných dní** — jedeme volně. Zastávky jsou **v pořadí, jak pojedeme**. *(Co už bylo → [CESTOVNI-DENIK.md](CESTOVNI-DENIK.md).)*

### Legenda
- **⚡** nabíjení · **🛏️** spaní (🇳🇴🇸🇪🇫🇮 zdarma, allemansrätten) · **⭐** highlight
- **🟢** základna s jistou wifi → sem **středa = meeting day**
- **🚗** zastávka cestou · **🚢** trajekt (volitelný) · **🛒** nákup

---

## 🇩🇪🇩🇰🇳🇴 Úsek 1 — Na sever + Dánsko + jižní Norsko

**Na sever *(hotovo — viz [deník](CESTOVNI-DENIK.md))*:**
- Tachov → Berlín → Hamburk → Dánsko → přes mosty do Švédska
- 💡 „Most Fehmarn" zatím neexistuje (tunel ~2029+) → DE–DK je trajekt Puttgarden nebo mosty přes Jutsko

**Švédské pobřeží → Göteborg** *(~200 km po E6, pohodový den):*
- 🚗 **Kullaberg** — útesy, maják, šance na **tuleně** 🦭
- 🚗 **Varberg** ⭐ — středověká pevnost u moře, lázně Kallbadhuset
- 🚗 **Tylösand** — jedna z nejslavnějších švédských pláží, koupačka
- 🛒 **Strömstad / Nordby** (u norské hranice) — velký levný nákup **před Norskem** (viz [JIDLO.md](JIDLO.md))
- **🟢 Göteborg** — 2. největší město, přístav
  - ⭐ **Haga** — dřevěné domky, obří skořicová buchta
...
## 🇸🇪🇫🇮 Úsek 4 — Laponie (Švédsko → Finsko)

- **🟢 Kiruna** *(~100 km)* ⭐ **Ledový hotel** Jukkasjärvi, obří rudný důl, „stěhující se město"
- **🟢 Rovaniemi** *(~480 km, hranice Finsko)* ⭐ **vesnice Santa Clause**, polární kruh podruhé, muzeum **Arktikum**, sobí farma · 🛏️ kemp
- **Oulu** *(~330 km)* ⭐ finská jezerní krajina, klid · 🛏️ divoko u jezera
- **🟢 Helsinki** *(~400 km, dá se dělit)* ⭐ katedrála, pevnost **Suomenlinna**, sauna · 🛏️ kemp Rastila

## 🇪🇪🇱🇻🇱🇹🇵🇱 Úsek 5 — Pobaltí → Polsko → domů

- 🚢 **Helsinki → Tallinn** *(~2 h, hranice Estonsko)* — jediné spojení do Pobaltí (most neexistuje)
- **Tallinn** ⭐ středověké **staré město** (UNESCO) · 🛏️ kemp
...
- **Varšava** *(~470 km, hranice Polsko)* ⭐ staré město (znovupostavené)
- **🟢 Krakov** *(~300 km)* ⭐ **Wawel**, **Rynek** (největší náměstí Evropy), příp. solný důl **Wieliczka** · 🛏️ kemp
...
- **Půlnoční slunce** (za polárním kruhem) — bez zatemnění oken se nevyspíš
- **Komáři v Laponii** — repelent + sítě
- **Nabíjení** — všude OK; jen vnitrozemí finské Laponie řidší (hlavní silnice v pohodě)
